...
export const Signin = ({label, svgg}) => {

    // const [username, setUsername] = useState("");
    // const [password, setPassword] = useState("");

    return <div class="w-full flex bg-white rounded-lg shadow dark:border md:mt-0 sm:w-[50rem] xl:p-0 dark:bg-gray-800 dark:border-gray-700">
